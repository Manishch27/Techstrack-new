...
const Contact = () => {
  ...
  return (
    <>
      <div id="contact" className="h-[450px] w-full dark:bg-slate-800  bg-slate-200 relative z-20 flex items-center justify-end text-white font-mdSans px-0 sm:px-24 py-16" >
